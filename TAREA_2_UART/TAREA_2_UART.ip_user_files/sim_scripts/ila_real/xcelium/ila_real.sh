...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../TAREA_2_UART.gen/sources_1/ip/ila_real/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../TAREA_2_UART.gen/sources_1/ip/ila_real/hdl/verilog" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.ila_real xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.ila_real -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log ila_real_sc.so .tmp_log xcelium_lib waves.shm c.obj)
