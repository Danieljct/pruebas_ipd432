...
#
# Script generated by Vivado on Sun Oct 13 23:52:58 -0300 2024
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../TAREA_2_UART.gen/sources_1/ip/ila_0/hdl/verilog" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../TAREA_2_UART.gen/sources_1/ip/ila_0/hdl/verilog" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="E:/github/pruebas_ipd432/TAREA_2_UART/TAREA_2_UART.cache/compile_simlib/vcs"
  fi
