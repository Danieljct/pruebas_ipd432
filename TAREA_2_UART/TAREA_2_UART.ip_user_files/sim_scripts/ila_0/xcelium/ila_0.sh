...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../TAREA_2_UART.gen/sources_1/ip/ila_0/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../TAREA_2_UART.gen/sources_1/ip/ila_0/hdl/verilog" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="E:/github/pruebas_ipd432/TAREA_2_UART/TAREA_2_UART.cache/compile_simlib/xcelium"
  fi
