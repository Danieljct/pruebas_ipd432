...
vlog -work xpm  -incr -mfcu  -sv "+incdir+../../../ipstatic" "+incdir+../../../../Tarea2.gen/sources_1/ip/clk_wiz_0" \
...
vlog -work xil_defaultlib  -incr -mfcu  "+incdir+../../../ipstatic" "+incdir+../../../../Tarea2.gen/sources_1/ip/clk_wiz_0" \
