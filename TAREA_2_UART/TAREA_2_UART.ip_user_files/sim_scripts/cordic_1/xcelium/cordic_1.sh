...
#
# Script generated by Vivado on Sun Oct 13 12:42:04 -0300 2024
...
#
# Usage        : cordic_1.sh
#                cordic_1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                cordic_1.sh [-reset_run]
#                cordic_1.sh [-reset_log]
#                cordic_1.sh [-help]
#
...
#                script (type 'cordic_1.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname xbip_utils_v3_0_13 -libname c_reg_fd_v12_0_9 -libname xbip_dsp48_wrapper_v3_0_6 -libname xbip_pipe_v3_0_9 -libname xbip_dsp48_addsub_v3_0_9 -libname xbip_addsub_v3_0_9 -libname c_addsub_v12_0_18 -libname xbip_bram18k_v3_0_9 -libname mult_gen_v12_0_21 -libname axi_utils_v2_0_9 -libname cordic_v6_0_22 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm xbip_utils_v3_0_13 c_reg_fd_v12_0_9 xbip_dsp48_wrapper_v3_0_6 xbip_pipe_v3_0_9 xbip_dsp48_addsub_v3_0_9 xbip_addsub_v3_0_9 c_addsub_v12_0_18 xbip_bram18k_v3_0_9 mult_gen_v12_0_21 axi_utils_v2_0_9 cordic_v6_0_22 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "cordic_1.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./cordic_1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvhdl -work cordic_v6_0_22 $xmvhdl_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.cordic_1 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.cordic_1 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log cordic_1_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: cordic_1.sh [-step]\n\
Usage: cordic_1.sh [-lib_map_path]\n\
Usage: cordic_1.sh [-reset_run]\n\
Usage: cordic_1.sh [-reset_log]\n\
Usage: cordic_1.sh [-keep_index]\n\
