...
HD_PWD='E:/github/pruebas_ipd432/TAREA_2_UART/TAREA_2_UART.runs/ila_real_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_real.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ila_real.tcl
