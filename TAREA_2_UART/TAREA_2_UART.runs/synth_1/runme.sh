...
HD_PWD='E:/github/pruebas_ipd432/TAREA_2_UART/TAREA_2_UART.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_ECHO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TOP_ECHO.tcl
