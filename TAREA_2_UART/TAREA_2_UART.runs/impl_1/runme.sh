...
HD_PWD='E:/github/pruebas_ipd432/TAREA_2_UART/TAREA_2_UART.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_ECHO.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TOP_ECHO.tcl -notrace
