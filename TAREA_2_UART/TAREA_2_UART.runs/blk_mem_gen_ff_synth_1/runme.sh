...
HD_PWD='E:/github/pruebas_ipd432/TAREA_2_UART/TAREA_2_UART.runs/blk_mem_gen_ff_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_gen_ff.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_gen_ff.tcl
