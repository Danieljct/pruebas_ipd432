...
HD_PWD='E:/github/pruebas_ipd432/UART_PROFE/UART_PROFE.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ME_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ME_top.tcl -notrace
