...
HD_PWD='E:/github/pruebas_ipd432/UART_PROFE/UART_PROFE.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ME_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ME_top.tcl
