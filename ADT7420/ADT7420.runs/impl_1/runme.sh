...
HD_PWD='E:/github/pruebas_ipd432/ADT7420/ADT7420.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bypass_sensor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bypass_sensor.tcl -notrace
