...
HD_PWD='E:/github/pruebas_ipd432/ADT7420/ADT7420.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bypass_sensor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bypass_sensor.tcl
