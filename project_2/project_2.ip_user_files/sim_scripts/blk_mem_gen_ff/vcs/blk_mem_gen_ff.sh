...
#
# Script generated by Vivado on Mon Oct 21 21:08:10 -0300 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : blk_mem_gen_ff.sh
...
#
# Usage        : blk_mem_gen_ff.sh
#                blk_mem_gen_ff.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                blk_mem_gen_ff.sh [-reset_run]
#                blk_mem_gen_ff.sh [-reset_log]
#                blk_mem_gen_ff.sh [-help]
#
...
#                script (type 'blk_mem_gen_ff.sh -help' for more information).
#
...
# script info
echo -e "blk_mem_gen_ff.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./blk_mem_gen_ff.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.blk_mem_gen_ff xil_defaultlib.glbl -o blk_mem_gen_ff_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./blk_mem_gen_ff_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key blk_mem_gen_ff_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc blk_mem_gen_ff_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./blk_mem_gen_ff.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: blk_mem_gen_ff.sh [-help]\n\
Usage: blk_mem_gen_ff.sh [-step]\n\
Usage: blk_mem_gen_ff.sh [-lib_map_path]\n\
Usage: blk_mem_gen_ff.sh [-reset_run]\n\
Usage: blk_mem_gen_ff.sh [-reset_log]\n\
Usage: blk_mem_gen_ff.sh [-keep_index]\n\
Usage: blk_mem_gen_ff.sh [-noclean_files]\n\n\
